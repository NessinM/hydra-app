...
.h-screen.overflow-y-auto.overflow-x-hidden.bg-gray-200
        ...
        ul.flex.flex-col.p-2.rounded-lg.items-center(class='md:flex-row  md:mt-0 md:text-sm md:font-medium md:border-0')
          li.mx-1
            button.text-white.bg-gradient-to-r.from-gray-400.via-gray-500.to-gray-600.shadow-lg.font-bold.rounded-lg.text-xs.px-5.text-center(
              ...
              font-awesome-icon.fa-1x.mx-1(icon='fa-solid fa-building-circle-check')
              | SUNAT
          li.mx-1
            button.text-white.bg-gradient-to-r.from-red-400.via-red-500.to-red-600.shadow-lg.font-bold.rounded-lg.text-xs.px-5.text-center(
              ...
              font-awesome-icon.fa-1x.mx-1(icon='fas fa-code')
              | PDF
          li.mx-1
            button.text-white.bg-gradient-to-r.from-yellow-400.via-yellow-500.to-yellow-600.shadow-lg.font-bold.rounded-lg.text-xs.px-5.text-center(
  ...
  pre.bg-gray-100.text-blue-600.px-4.py-4.text-xs.font-bold(v-if="typeViewRender === 'xml' && dataBaseXML && !isLoading")
    | {{dataBaseXML}}
  pre.text-red-500.px-4.py-4.font-bold(v-if="typeViewRender === 'xml' && !dataBaseXML && !isLoading")
